...
window.ALL_UPGRADES = [
  ...
  // DVD
  { id:'dvd0', type:'passive', group:'dvd', tier:0, icon:'📀', img:'img/upg_dvd.png',
    name:'DVD логотип', desc:'DVD відскакує від країв.\nКожен удар +1.',
    req:[], apply(S){ S.dvdActive=true; } },
  { id:'dvd1', type:'passive', group:'dvd', tier:1, icon:'📀', img:'img/upg_dvd.png',
    name:'DVD логотип +', desc:'DVD швидший, удар +3.',
    req:['dvd0'], apply(S){ window.dvdObj.speed*=1.6; window.dvdObj.bonus=3; } },
  { id:'dvd2', type:'passive', group:'dvd', tier:2, icon:'📀', img:'img/upg_dvd.png',
  ...
  { id:'crit0', type:'passive', group:'crit', tier:0, icon:'💥', img:'img/upg_crit.png',
    name:'Крит! ×2', desc:'Критичний удар тепер дає ×2 очок.',
    req:[], apply(S){ S.critMulti=2; } },
  { id:'crit1', type:'passive', group:'crit', tier:1, icon:'💥', img:'img/upg_crit.png',
    name:'Крит! ×2 +', desc:'Крит тепер дає ×3 очок.',
    req:['crit0'], apply(S){ S.critMulti=3; } },
  { id:'crit2', type:'passive', group:'crit', tier:2, icon:'💥', img:'img/upg_crit.png',
    name:'Крит! ×2 ++', desc:'Крит тепер дає ×4 очок.',
    req:['crit1'], apply(S){ S.critMulti=4; } },

  // Свин
  { id:'pig0', type:'passive', group:'pig', tier:0, icon:'🐷', img:'img/upg_pig.png',
  ...
  { id:'pig1', type:'passive', group:'pig', tier:1, icon:'🐷', img:'img/upg_pig.png',
    name:'Свин ти куда? +', desc:'Швидша. Ручний ×3.',
    req:['pig0'], apply(S){ S.pigSpeed=2.4; S.pigMulti=3; } },
  { id:'pig2', type:'passive', group:'pig', tier:2, icon:'🐷', img:'img/upg_pig.png',
